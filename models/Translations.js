...
Translation.getTranslationsByDomainFilter = function(domain_id, code, callback){
    var sql = "SELECT t.id, t.code "+
            "FROM translation t "+
            "WHERE domain_id = '"+domain_id+"' "+
...
Translation.getTranslationsToLangByDomainFilter = function(domain_id, code, callback){
    var sql = "SELECT t.id, tl.lang_id, tl.trans "+
                "FROM translation_to_lang tl "+
                "JOIN translation t "+
                "ON t.id=tl.translation_id "+
